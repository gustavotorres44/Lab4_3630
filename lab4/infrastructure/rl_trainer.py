...
from lab4.infrastructure import pytorch_util as ptu
from lab4.infrastructure.logger import Logger
from lab4.infrastructure import utils
...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        # For Ant-v4, enable contact forces to match expert data observation space (111 dims)
        env_name = self.params['env_name']
        if 'Ant' in env_name:
            self.env = gym.make(env_name, use_contact_forces=True, render_mode="rgb_array")
        else:
            self.env = gym.make(env_name, render_mode="rgb_array")
        self.seed = seed  # Store seed for reset calls
        ...
        elif hasattr(self.env, 'metadata') and 'render_fps' in self.env.metadata:
    ...
    def collect_training_trajectories(
        ...
        # TODO: decide whether to load expert data or collect fresh rollouts.
        # HINT: on iteration 0, bootstrap training by loading the expert
